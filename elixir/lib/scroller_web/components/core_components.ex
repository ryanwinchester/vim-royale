defmodule ScrollerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ScrollerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ScrollerWeb.Gettext, "errors", msg, opts)
    # end
